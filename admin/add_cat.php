...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
		...
		<center><h4 style=color:blue;><b>Add a new Category</b></style></h4><br></center>
		<div class="row">
...
if (isset($_POST['add_cat'])) {
    ...
    if ($query_submition) {
        echo '<script>window.onload = function() { alert("Category added successfully..."); }</script>';
    } else {
        echo '<script>window.onload = function() { alert("Category adding Error"); }</script>';
    }
}
?>
