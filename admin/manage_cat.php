...
<body>
	...
	<span><marquee><b>Library Management System|Brought to you by <span style=color:red;>Tech Alliance</style>.</b></marquee></span><br><br>
		<center><h4 style=color:blue;><u>Manage Category</u></style></h4><br></center>
		<div class="row">
					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn btn-warning"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>"style=color:black;>Edit</a></button>
								<button class="btn btn-danger"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>"style=color:white;>Delete</a></button></td>
							</tr>
							<?php
						}
					?>
