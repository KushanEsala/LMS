...
<body>
    ...
    <center><h4 style="color:blue;"><b>Manage Category</b></h4><br></center>
    <div class="row">
                ...
                <?php
                    ...
                    while ($row = mysqli_fetch_assoc($query_run)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning"><a href="edit_cat.php?cid=<?php echo $row['cat_id']; ?>">Edit</a></button>
                                <button class="btn btn-danger"><a href="delete_cat.php?cid=<?php echo $row['cat_id']; ?>">Delete</a></button>
                            </td>
                        </tr>
                        <?php
                    }
