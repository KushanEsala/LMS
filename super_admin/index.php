...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			...
			<li class="nav-item">
		        <a class="nav-link" href="index.php"style=color:#00C957;><b>Super Admin Login</b></style></a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="../admin/index.php"style=color:#00C957;><b>Admin Login</style></b></a>
		      </li>
		      <li class="nav-item">
	...
	<div class="row">
		...
		<div class="col-md-8" id="main_content">
			<center><h3 style=color:blue;><u>Super Admin Login Form</u></style></h3></center>
			...
			<?php 
				if(isset($_POST['login'])){
					...
					$query = "select * from super_admin where email = '$_POST[email]'";
