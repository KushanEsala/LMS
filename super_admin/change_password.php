...
<body>
	...
	<span><marquee><b>Library Management System|Brought to you by <span style=color:red;>Tech Alliance</style>.</b></marquee></span><br><br>
		<center><h4 style=color:blue;><u>Change super Admin Password</u></style></h4><br></center>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
			<form action="update_password.php" method="post"> 
			<input type="text" class="form-control" name="super_adminEmail" id="super_adminEmail" value="<?php echo $_SESSION['email']; ?>" hidden>
