<?php
	...
	$book_no = "";
	$user_name = "";
	$query = "select returned_books.book_name,returned_books.book_author,returned_books.isbn_no,users.name from returned_books left join users on returned_books.user_id = users.id where returned_books.status = 1";
?>
<!DOCTYPE html>
<html>
<head>
