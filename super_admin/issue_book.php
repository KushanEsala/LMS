		...
		<div class="row">
			...
			<div class="col-md-4">
				<form action="" method="post">
					...
					<div class="form-group">
						<label for="book_no"><b>Book Number:</b></label>
...
<?php
	if(isset($_POST['issue_book']))
	{
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "insert into issued_books values(null,$_POST[book_no],'$_POST[book_name]','$_POST[book_author]',$_POST[user_id],1,'$_POST[issue_date]')";
		$query_run = mysqli_query($connection,$query);
