	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<div class="navbar-header">
				<img src="FB_IMG_1598014466734.jpg" alt="Default Profile" style="width: 40px; height: 40px; border-radius: 50%;">
		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-secondary" href="view_issued_book.php" target="_blank">View Issued Books</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-info" href="view_returned_book.php" target="_blank">View Returned Books</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-danger" href="view_add_staff.php" target="_blank">View Staff Members</a>
				</div>
			</div>
		<div>
