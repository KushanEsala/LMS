<?php
	...
	$author = "";
	$book_no = "";
	$query = "select book_name,book_author,isbn_no,issue_date from issued_books where user_id = $_SESSION[id] and status = 1";
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<span><marquee><b>Library Management System|Brought to you by <span style=color:red;>Tech Alliance</style>.</b></marquee></span><br><br>
		<center><h4 style=color:blue;><b>Issued Books Details</b></style></h4><br></center>
		<div class="row">
