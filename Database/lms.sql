...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2024 at 04:25 PM
...
(1, 'Admin', 'admin@gmail.com', 'admin@123', 771631321);
...
(21, 'Statistic & Probabilistic', '184', 4, 600, 5000.00, 4, 0),
(22, 'IT World', '186', 1, 123, 2000.00, 12, 1),
(23, 'Heen saraya', '183', 1, 44, 5345.00, 4, 1),
(24, 'Madolduwa', 'Sadeepa Kaushika', 5, 777, 775.00, 7, 0),
(25, 'ddddd', 'Sadeepa Kaushika', 2, 1213241312, 150000.00, 231, 127),
(26, 'ddddd', 'Sadeepa Kaushika', 2, 1213241312, 150000.00, 231, 127);
...
(8, 2, 22, 'Admin', 'IT World', '2024-06-28 17:51:29', 'Accepted'),
(9, 2, 23, 'Admin', 'Heen saraya', '2024-06-28 17:51:31', 'Declined'),
(10, 2, 26, 'Admin', 'ddddd', '2024-06-28 17:51:34', '0'),
(11, 11, 22, 'qwertyu', 'IT World', '2024-06-28 18:14:56', '0');
...
(4, 'Madushani', 'madushani@gmail.com', '1234', 112365478, 'kandy,Hanguranketha', 'Library Assistant', 20000.00),
...
(2, 'Admin', 'admin@gmail.com', 'admin@123', 781166467, '19km,Hanguranketha Road,Mailapitiya', 'WhatsApp Image .jpg', '2024-01-01', 'admin'),
...
(6, 'Kushan', 'kushan@gmail.com', '$2y$10$9WIKQbgYZOiRXJbxPdL4a.UsHhczqBs30JGb2IjgGYIvVWBchzb3O', 125416377, ',njbh', '', '2024-06-23', 'user');
...
--
ALTER TABLE `authors`
  MODIFY `author_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;
