...
<body>
	...
	<div class="row">
		...
		<div class="col-md-8" id="main_content">
			<center><h3 style=color:blue;><B>About US</B></style></h3></center>
			...
			<br>But LibraLink Library is more than just a repository of books. We're a dynamic center for exploration and growth, offering state-of-the-art resources, technology, and innovative programs that empower individuals to thrive in an ever-evolving world.</p>

			<center><h3 style=color:blue;><B>Our Mission</B></style></h3><br></center>
			...
			<b>Empowerment:</b> Empowering individuals to explore, create, and succeed by fostering a culture of curiosity and exploration.<br><br>	</p>
			</form>
		</div>
	</div>
</body>
